...
public class PhuongThucThanhToanRepository {
    ...
    // 2. Thêm mới (Không insert ma_pttt để SQL tự sinh)
    ...
    // 3. Cập nhật thông tin (Chỉ sửa tên)
    ...
    // 5. Xóa vĩnh viễn (Lưu ý: Có rủi ro mất data lịch sử hóa đơn)
