...
<head>
    ...
    <style>
        ...
        .form-control:focus, .form-select:focus { box-shadow: 0 0 0 3px rgba(220, 38, 38, 0.15); border-color: #DC2626; }
        .badge { font-weight: 600; padding: 0.4em 0.8em; border-radius: 9999px; }
        .btn-brand { background-color: #DC2626; color: white; }
        .btn-brand-danger { background-color: #DC2626; color: white; }
        .btn-brand-danger:hover, .btn-brand:hover { background-color: #B91C1C; color: white; }
        .text-brand-danger { color: #DC2626; }
        .modal-content { border-radius: 1.25rem; border: none; }
        .voucher-code { font-family: monospace; font-size: 1.1rem; letter-spacing: 2px; border: 2px dashed #DC2626; color: #DC2626; background: #FEF2F2; padding: 0.2rem 0.6rem; border-radius: 6px; font-weight: 800;}
    </style>
</head>
<body>
...
<div class="container-fluid mt-4 px-4 mb-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="text-dark fw-bold m-0"><i class="bi bi-ticket-perforated-fill text-brand-danger me-2"></i>Chương Trình Khuyến Mãi</h3>
        ...
        <div class="col-lg-3 mb-4">
            <div class="card">
                <div class="card-header border-bottom-0 pb-0 pt-4">
                    <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-gift-fill text-brand-danger me-2"></i>Tạo Mã Mới</h5>
                </div>
                <div class="card-body p-4">
                    <form action="${pageContext.request.contextPath}/khuyen-mai" method="post" onsubmit="showConfirmForm(event, this, 'Phát Hành Mã', 'Xác nhận tạo mới chương trình khuyến mãi này?');">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold small text-brand-danger text-uppercase">Mã Code Nhập</label>
                            <input type="text" name="maCode" class="form-control text-uppercase fw-bold fs-5" style="border-color: #DC2626;" required placeholder="VD: TET2026">
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-brand-danger w-100 py-2"><i class="bi bi-check2-circle me-1"></i> Phát Hành</button>
                    </form>
                </div>
            </div>
        </div>
                                ...
                                <c:when test="${not empty requestScope.danhSach}">
                                    <c:forEach var="km" items="${requestScope.danhSach}" varStatus="status">
                                        <tr>
                                            ...
                                            <td><span class="voucher-code">${km.maCode}</span></td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg">
            <div class="modal-header bg-light border-0 py-3">
                <h5 class="modal-title fw-bold text-dark"><i class="bi bi-pencil-square text-brand-danger me-2"></i>Cập Nhật Khuyến Mãi</h5>
            ...
            <form action="${pageContext.request.contextPath}/khuyen-mai" method="post" onsubmit="showConfirmForm(event, this, 'Lưu Thay Đổi', 'Bạn chắc chắn muốn lưu thông tin này?');">
                ...
                <div class="modal-footer bg-light border-0 p-3">
                    ...
                    <button type="submit" class="btn btn-brand-danger fw-bold rounded-pill px-4">Lưu Thay Đổi</button>
                </div>
            </form>
        </div>
    </div>
