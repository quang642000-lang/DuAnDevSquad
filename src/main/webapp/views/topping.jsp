    ...
    <div class="main-content">
        <header class="top-navbar bg-white shadow-sm mb-4 px-4 py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="text-dark fw-bold m-0"><i class="bi bi-cup-hot-fill text-brand me-2"></i>Quản Lý Topping</h4> <!-- Sửa tên tiêu đề tương ứng -->
            </div>
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-2 text-end">
                                <c:if test="${not empty param.keyword}">
                                    <a href="${pageContext.request.contextPath}/topping?action=list" class="btn btn-outline-danger fw-bold w-100"><i class="bi bi-x-circle"></i> Xóa Lọc</a>
                                </c:if>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="table-responsive">
                        ...
                        <c:if test="${totalPages > 1}">
                            <jsp:include page="layout/pagination.jsp">
                                <jsp:param name="baseUrl" value="/topping?action=list" />
                            </jsp:include>
                        </c:if>
                    </div>
                </div>
            ...
            <form action="${pageContext.request.contextPath}/topping" method="post" enctype="multipart/form-data" onsubmit="showConfirmForm(event, this, 'Lưu Thay Đổi', 'Bạn có chắc chắn muốn lưu thông tin này?');">
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3 text-center">
                        <img id="preview_hinhAnh" src="" alt="Preview" class="img-thumbnail border-0 shadow-sm rounded-4" style="width: 100px; height: 100px; object-fit: cover;">
                    </div>
    ...
    $(document).ready(function() {
        if ($('#toppingTable tbody td').length > 1) {
            $('#toppingTable').DataTable({
                ...
                "language": {
                    "emptyTable": "<div class='text-muted py-5'><i class='bi bi-inbox fs-1 d-block mb-3 opacity-50'></i>Chưa có Topping nào.</div>"
                }
            });
        }
    });
